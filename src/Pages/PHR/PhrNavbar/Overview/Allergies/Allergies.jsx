...
//   return (
//     <>
//     <div className='py-3  bg-[#F9FAFB] mx-3 my-5 rounded-t-xl'>
//         <div className='px-8 flex items-center justify-between'>
//           <TextTitle text={"Social History"} />
//           <Update/>
//         </div>
...
//           <p className='landing-6 font-semibold'>Excercise</p>
//             </div>
            
//         <div className='flex gap-3  px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>7 Days Per week</p>
//             </div>
            
//             <div className='flex gap-3 px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>1hr per session</p>
//             </div>

//             <div className='flex gap-3 px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>Type of excercise: <span>Yoga</span></p>
//             </div>
//           </div>
...
//           <div className='flex flex-col gap-1'>
//         <div className='flex gap-3 py-3 px-5 items-center'>
//           <img src={PhrAssets.Sleep_icon} alt="" />
//           <p className='landing-6 font-semibold'>Sleep</p>
//             </div>
            
//         <div className='flex gap-3  px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>8 per night</p>
//             </div>
            
//             <div className='flex gap-3 px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>sometimes during sleeping</p>
//             </div>
...
//           <p className='landing-6 font-semibold'>Smoking</p>
//             </div>
            
//         <div className='flex gap-3  px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>Never Smoke</p>
//             </div>
            
//             <div className='flex gap-3 px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>No one else in your home smoke</p>
//            </div>
//           </div>
...
//         <div className='flex gap-3  px-6 items-baseline'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>8-13 Alcoholic beverages do you drink per week</p>
//         </div>
//       </div>
//     </div>
...
//         <div className='flex gap-3 py-3 px-5 items-center'>
//           <img src={PhrAssets.Others_icon} alt="" />
//           <p className='landing-6 font-semibold'>Others</p>
//         </div>
            
//         <div className='flex gap-3  px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>Current living with Family</p>
//         </div>

//         <div className='flex gap-3 px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>Collage Degree Highest education level</p>
//         </div>
          
//         <div className='flex gap-3 px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>Very LittleStress affected your health</p>
//         </div>
          
//         <div className='flex gap-3 px-6'>
//           <img src={PhrAssets.Blackbar_icon} alt="" />
//           <p className='landing-6'>Mostly satisfied are you with your life</p>
//         </div>
//       </div>
...
const Allergies = () => {
  ...
  const openPhrUpdatePage = () => {
    ...
    // Navigate to the OverviewPhrUpdate page
    navigate("/OverviewPhrUpdate");
  };

  return (
    <>
      <div className='py-3 px-8 bg-[#F9FAFB] my-5 mx-10 rounded-t-xl'>
        <div className='flex justify-between'>
          <TextTitle text={"Other Details"} />
          {/* <TextTitle className={"Other Details"} /> */}
          <Update onClick={openPhrUpdatePage} />
        </div>
        <p className="border border-gray-200 px-2 my-3"></p>
