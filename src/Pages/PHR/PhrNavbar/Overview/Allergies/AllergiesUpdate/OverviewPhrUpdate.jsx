  ...
  return (
    <>
      <div className="min-h-screen bg-white flex flex-col">
        {/* Header */}
        <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between py-4 px-4 sm:px-6 md:px-8 lg:px-12 bg-[#001940] shadow-md w-full">
        ...
        {/* Main Section */}
        <div className="px-2 md:p-5 lg:px-10 w-full">
          {/* Medical & Surgery */}
          ...
          <div className="flex flex-col md:flex-row">
            {/* Button Tabs */}
            <div className="w-full md:w-[35%] flex overflow-x-auto md:overflow-hidden gap-2 px-1 lg:px-10 py-5 md:flex-col md:gap-2 ">
    {[
      ...
      <button
        ...
        className={`flex-shrink-0 whitespace-nowrap px-4 md:px-2  py-3 text-sm md:text-base text-left font-semibold transition duration-300 ease-in-out ${
          activeTab === index
      ...
      >
        {label}                                      
            ...
            {/* Content */}
            <div className="md:w-[70%] bg-[#F9FAFB] px-4 py-6 mt-6 h-auto rounded-lg ">
              {renderTabContent()}
            </div>
          </div>
        </div>
