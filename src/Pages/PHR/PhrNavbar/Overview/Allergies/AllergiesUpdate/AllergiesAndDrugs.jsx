...
const AllergiesAndDrugs = () => {
  ...
  const [data, setData] = useState([]); // Allergies data
  const [groupedData, setGroupedData] = useState({}); // Grouped allergies by module
  ...
  const GetAllergiesAndDrugsApi = async () => {
    ...
    try {
      ...
      // Group allergies by allergiesDrugGroupName
  ...
  const renderSection = (title, items) => (
    <div className="mb-8">
      <h2 className="font-semibold text-base text-gray-800 mb-4">{title}</h2>
