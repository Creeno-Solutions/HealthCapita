        ...
        <div className="flex gap-3 py-4">
          ...
          <div className="flex flex-col">
            <div className="flex flex-row gap-3 py-1 px-2">
              <img src={PhrAssets.Blackbar_icon} alt="" />
              <p>
                Have you been exposed to any toxic or hazardous substances ?
              </p>
            </div>
            ...
            <div className="flex flex-row gap-3 py-1 px-2">
              <img src={PhrAssets.Blackbar_icon} alt="" />
              <p>
                Do you have any dietary restrictions ? Please describe. (ex: low
                salt, vegetarian, no sugar, etc.)
              </p>
            </div>
            ...
            <div className="flex flex-row gap-3 py-1 px-2">
              ...
              <p>
                ...
                convictins that may affect how you should be treated medically ?
                Please describe.
              </p>
            </div>
            ...
            <div className="flex flex-row gap-3 py-1 px-2">
              <img src={PhrAssets.Blackbar_icon} alt="" />
              <p>
                Are you now or have you previously been in an abusive
                relationship (verbally, emotionally, physically, or sexually) ?
              </p>
            </div>
          </div>
        </div>
