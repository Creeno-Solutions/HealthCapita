    ...
    <>
      <div className='py-5 px-5 mx-8 my-7 bg-[#F9FAFB]'>
        ...
        <div className='flex items-center gap-3'>
          <img className='p-2 rounded-full bg-[#FFF1F1]' src={PhrAssets.MedicalContact} alt=""/>
            <p className='font-medium landing-5 text-lg text-[#111928]'>Medical Contacts</p>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4'>
          ...
          <div className='flex flex-col bg-[white] py-2 px-3 rounded-md gap-2'>
            ...
            <div className='flex flex-col bg-[white] py-2 px-3 rounded-md gap-2'>
              ...
              <p className=' text[#374151] font-semibold landing-5'>+965-9988766554</p>
            </div>
